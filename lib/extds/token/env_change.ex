defmodule ExTds.Token.EnvChange do
  ...
  def parse(connection, <<0xE3, length :: little-size(16), 0x08, tail :: binary>>) do
  ...
  def parse(connection, <<0xE3, length :: little-size(16), 0x0A, tail :: binary>>) do
  ...
  def parse(connection, <<0xE3, length :: little-size(16), 0x09, tail :: binary>>) do
    <<0x00, size, old_value :: binary-size(size), tail :: binary>> = tail
